...
def main_pop_up(info, info1, info2, info3, info4):
    win= tk.Tk()

    label= tk.Label(win, text=info)
    label.pack()

    label= tk.Label(win, text=info1)
    label.pack()
    label= tk.Label(win, text=info2)
    label.pack()
    label= tk.Label(win, text=info3)
    label.pack()
    label= tk.Label(win, text=info4)
    label.pack()
...
class settings:
    ...
    def get_settings(self):
        ...
        #print(settings['data']['settings'][1])
        main_pop_up(settings['data']['settings'][0],settings['data']['settings'][1], settings['data']['settings'][2], settings['data']['settings'][3], settings['data']['settings'][4])
...
class change_settings:
    ...
    def change_freezer_temp(self):
        ...
        info_pop_up("The current temperature is {} °C".format(current_freezer_temp))
        ...
        if ans1.lower() == 'yes':
            ...
            while value < -24 or value > -16:
                info_pop_up('The bounds are {} and {} try again'.format(self.freezer_min, self.freezer_max))
            ...
            info_pop_up('Changing temperature to {} °C '.format(value))
        else:
            info_pop_up("Error")
            #print("Error")
        SQL().Create()
    ...
    def change_fridge_temp(self):
        ...
        info_pop_up("The current temperature is {} °C".format(current_fridge_temp))
        ...
        if ans1.lower() == 'yes':
            ...
            while value < 2 or value > 8:
                info_pop_up('The bounds are {} and {} try again'.format(self.fridge_min, self.fridge_max))
...
btn3=Button(window, text="Get Settings", fg='blue',width = 25, height = 25, command = settings().get_settings)
...
btn6 = Button(window, text="Get SQL data", fg='blue',width = 25, height = 25, command = SQL().Print)
btn6.grid(column=1, row=1)

btn7=Button(window, text="This is Button widget", fg='blue',width = 25, height = 25)
btn7.grid(column=2, row=1)

btn8 = Button(window, text="Exit", fg='blue',width = 25, height = 25, command = exit)
